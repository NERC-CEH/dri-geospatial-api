...
awslocal s3api put-object --bucket ukceh-fdri-staging-geospatial --key project=fdri/location_type=catchment/location=tweed/data_category=dsm/processing_level=processed/date=2026-03-20/clipped_tweed_dsm_3857_greyscale_cog.tif --body /var/lib/localstack/data/clipped_tweed_dsm_3857_greyscale_cog.tif
